...
the engines, we need to elaborate more on the \emph{languages} these engines use
to transform non-RDF to RDF data. 
...
of \emph{rr:parentTriplesMap} predicate \cite{triple_wave}.
...
%only applies 1 to 1 mapping. any transformation is delegated to RSP consuming its output
